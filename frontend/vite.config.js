  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "elements-alerts": resolve(
          __dirname,
          "src-modern/elements-alerts.html"
        ),
        "elements-badges": resolve(
          __dirname,
          "src-modern/elements-badges.html"
        ),
        "elements-buttons": resolve(
          __dirname,
          "src-modern/elements-buttons.html"
        ),
        ...
        "elements-modals": resolve(
          __dirname,
          "src-modern/elements-modals.html"
        ),
        "elements-tables": resolve(
          __dirname,
          "src-modern/elements-tables.html"
        ),
